...
export default function LockInPage() {
  ...
  return (
    <div className="h-full w-full overflow-auto relative flex flex-col">
      ...
      {/* Intensity Meter - Higher up */}
      <div className="relative z-10 px-4 py-2 md:py-3 flex-shrink-0">
        <div className="w-full max-w-md mx-auto">
          <div className="space-y-1">
            <div className="flex items-center justify-between text-[9px] md:text-[10px] font-mono text-muted-foreground uppercase tracking-wider">
              <span>Intensity</span>
              <span data-testid="text-intensity-percentage">87%</span>
            </div>
            <div className="h-1 bg-border rounded-full overflow-hidden" role="progressbar" aria-valuenow={87} aria-valuemin={0} aria-valuemax={100} aria-label="Focus intensity">
              <div className="h-full bg-gradient-to-r from-primary via-secondary to-destructive w-[87%] 
                           rounded-full animate-pulse" />
            </div>
            <div className="flex items-center justify-between text-[8px] md:text-[9px] font-mono text-muted-foreground/60 uppercase">
              <span>Locked In</span>
      ...
      <div className="relative z-10 flex-shrink-0 px-4 pb-4 md:pb-6 space-y-2 md:space-y-3">
          {/* Contextual Mantra */}
          ...
          <div className="border-t border-border/50 bg-card/60 backdrop-blur-sm px-4 py-2 rounded-lg">
            <div className="max-w-7xl mx-auto flex justify-around items-center text-center gap-4">
              <div className="flex-1">
                <p className="text-[8px] md:text-[9px] font-mono text-muted-foreground uppercase tracking-wider mb-0.5">Session</p>
                <p className="text-xs md:text-sm font-mono font-bold" data-testid="text-session-time">00:47:32</p>
              </div>
              <div className="flex-1">
                <p className="text-[8px] md:text-[9px] font-mono text-muted-foreground uppercase tracking-wider mb-0.5">Today</p>
                <p className="text-xs md:text-sm font-mono font-bold" data-testid="text-today-time">04:32:18</p>
              </div>
              <div className="flex-1">
                <p className="text-[8px] md:text-[9px] font-mono text-muted-foreground uppercase tracking-wider mb-0.5">Streak</p>
